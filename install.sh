...
wget https://github.com/bjendaik/ubuntuTermux11/raw/main/xfce.sh
wget https://github.com/bjendaik/ubuntuTermux11/raw/main/proot.sh
wget https://github.com/bjendaik/ubuntuTermux11/raw/main/utils.sh
chmod +x *.sh
